  ...
  const loadStations = React.useCallback(async () => {
    try {
      ...
      try {
        ...
        const stops: any[] = Array.isArray(stopsJson?.stops)
          ? stopsJson.stops
          : [];
        const names = Array.from(
          new Set(
            stops
              .map((s: any) => String(s.stop_name || "").trim())
              .filter(Boolean)
          )
        );
        setStations(names);
            ...
            <CardContent>
              <div className={styles.kpiHeader}>
                ...
                <div className={styles.kpiInfo}>
                  ...
                  <div className={styles.kpiValue}>
                    {getAverageValue("energyUsage")} kWh
                  </div>
                </div>
              </div>
              <div className={styles.kpiTrend}>
            ...
            <CardContent>
              <div className={styles.kpiHeader}>
                ...
                <div className={styles.kpiInfo}>
                  ...
                  <div className={styles.kpiValue}>
                    {getAverageValue("waitTimeReduction")}%
                  </div>
                </div>
              </div>
              <div className={styles.kpiTrend}>
          ...
          <Card variant="elevated" className={styles.chartCard}>
            <CardHeader>
              <h2 className={styles.chartTitle}>
                Forecast Demand ({selectedStation || "Station"})
              </h2>
            </CardHeader>
            <CardContent>
              <Chart
