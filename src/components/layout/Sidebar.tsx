...
const commuterItems: SidebarItem[] = [
  ...
  {
    href: "/commuter/dashboard/tickets",
    label: "Tickets",
    icon: <FiCreditCard />,
  },
  {
    href: "/commuter/dashboard/plan",
    label: "Plan Trip",
    icon: <FiNavigation />,
  },
  { href: "/commuter/dashboard/alerts", label: "Alerts", icon: <FiBell /> },
  {
    href: "/commuter/dashboard/settings",
    label: "Settings",
    icon: <FiSettings />,
  },
];
...
const adminItems: SidebarItem[] = [
  {
    href: "/admin/dashboard/tomorrows-plan",
    label: "Tomorrow's Plan",
    icon: <FiCalendar />,
  },
  {
    href: "/admin/dashboard/induction",
    label: "Induction",
    icon: <FiBarChart2 />,
  },
  {
  ...
  return (
    <aside
      className={`${styles.sidebar} ${
        isCollapsedEffective ? styles.collapsed : ""
      } ${isOpen ? styles.open : ""}`}
    >
